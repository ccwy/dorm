...
from models.room import Room  # 新增：导入Room模型
...
class RoomUtilityRecord(db.Model):
    ...
    def create_empty_records_for_period(cls, billing_period, room_ids=None):
        ...
        try:
            ...
            if room_ids is None:
                # 假设存在Room模型，获取所有房间ID
                from models.room import Room  # 延迟导入避免循环依赖
    ...
    def delete(self):
        ...
        try:
            ...
            # 删除关联的退宿子表记录
            from models.utility_room_bill_occupant import RoomUtilityOccupant  # 延迟导入
    ...
    def batch_update_from_meter(cls, billing_period, meter_readings, main_records):
        ...
        try:
            ...
            from models.utility_room_meter import UtilityMeterReading  # 统一导入位置
